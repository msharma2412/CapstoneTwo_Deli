...
public class Sandwich extends Product {
    ...
    public Sandwich(double sandwichPrice, int size, String bread, ArrayList<String> regToppings, ArrayList<String> meats, ArrayList<String> cheeses, ArrayList<String> sauces) {
